...
function ShopCategory() {
  ...
  return (
    <div className="container mx-auto max-w-2xl md:max-w-4xl lg:max-w-6xl px-2 py-12 sm:py-16 md:py-20 lg:py-20 space-y-12 text-black dark:text-white">
      ...
      <ul className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-3 md:gap-4">
